...
begin
  ...
  begin
    if ServiceConexao.FDQuery_transacoes.FieldByName('tra_tipo').AsString = 'Saída' then
    Soma := Soma + ServiceConexao.FDQuery_transacoes.FieldByName('tra_valor').AsFloat;
    ServiceConexao.FDQuery_transacoes.Next;  // move para o próximo
  end;
